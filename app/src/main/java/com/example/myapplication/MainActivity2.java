...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=findViewById(R.id.tsign);
        uid=findViewById(R.id.tuser);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (s.equals("") && s0.equals("")) {
                    Toast.makeText(MainActivity2.this, "Invalid registration", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MainActivity2.this, "Invalid registration", Toast.LENGTH_SHORT).show();
                    Intent i0 = new Intent(MainActivity2.this, MainActivity2.class);
                    startActivity(i0);
                }
                else {
                    Toast.makeText(MainActivity2.this, "Registration", Toast.LENGTH_SHORT).show();
